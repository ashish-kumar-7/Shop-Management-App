...
//      imageUrl:
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    var url = 'https://flutter-update-72.firebaseio.com/products.json?auth=$authToken&$filterString';
    try{
    ...
    url = 'https://flutter-update-72.firebaseio.com/userFavorites/$userId.json?auth=$authToken';
  ...
  Future<void> addProduct(Product product) async {
    final url = 'https://flutter-update-72.firebaseio.com/products.json?auth=$authToken';
    try {
  ...
  Future<void> updateProduct(String  id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url = 'https://flutter-update-72.firebaseio.com/products/$id.json?auth=$authToken';
